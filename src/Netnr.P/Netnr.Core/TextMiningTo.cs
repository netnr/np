...
public partial class TextMiningTo
{
    ...
    /// 结果
    /// </summary>
    public HashSet<string> Result { get; set; } = new();
    /// <summary>
    /// 穷举
    /// </summary>
    public Dictionary<string, int> DictItems { get; set; } = new();

    private readonly Dictionary<string, Dictionary<CharPos, int>> words = new();
    private readonly Dictionary<string, double> ps = new();
    private int total;
