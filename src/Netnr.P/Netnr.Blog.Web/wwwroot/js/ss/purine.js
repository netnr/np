...
var page = {
  bindGrid: function () {
    ...
    data.forEach(d => {
      d.rank = "低";
      d.class = "var(--sl-color-success-600)";
      if (d.number > 25) {
        d.rank = "中";
        d.class = "var(--sl-color-warning-600)";
      }
      if (d.number > 150) {
        d.rank = "高";
        d.class = "var(--sl-color-danger-600)";
      }
      d.rank += "嘌呤";
    })
    ...
    var gridOptions = ag.optionDef({
      columnDefs: [
        ...
        {
          field: "number", headerName: "含量", filter: "agNumberColumnFilter", filterParams: {
