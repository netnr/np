...
(function (window, undefined) {
    ...
    jz.blankClick = function (t, callback) {
        setTimeout(function () {
            ...
            jz(document).click(function () {
                ...
                if (elem) {
                    elem.className = elem.className.replace("jzart-show", "");
                    setTimeout(function () {
                        try {
                            elem.parentElement.removeChild(elem);
                        } catch (e) { }
                    }, jz.art.config.animationTime);
                }
    ...
    jz.art = {
        ...
        //弹出层包
        wrap: function (obj) {
            var art = this.create('div', 'jzart jzart-fade');
        ...
        remove: function (id, time) {
            ...
            setTimeout(function () {
                if (id != null && id != "") {
                    var rt = jz(id = "#" + id);
                    if (rt.length) {
                        rt[0].className = rt[0].className.replace("jzart-show", "");
                    }
                    setTimeout(function () {
                        rt.remove();
    ...
    jz.alert = function (content, obj) {
        obj = jz.art.pol(content, obj);
        obj.content = '<div class="jzart-bodycare">' + obj.content + '</div>';
