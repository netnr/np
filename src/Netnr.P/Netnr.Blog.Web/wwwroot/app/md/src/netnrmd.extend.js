    ...
    about: {
        ...
        action: function (that) {
            if (!that.aboutpopup) {
                ...
                //弹出
                that.aboutpopup = netnrmd.popup("关于", htm.join(''), that.isDark());
            }
    ...
    upload: {
        ...
        action: function (that) {
            if (!that.uploadpopup) {
                ...
                //保存创建的上传弹出
                that.uploadpopup = netnrmd.popup("上传", htm.join(''), that.isDark());
    ...
    import: {
        ...
        action: function (that) {
            if (!that.importpopup) {
                ...
                htm.push("</div>");
                //弹出
                that.importpopup = netnrmd.popup("导出", htm.join(''), that.isDark());
