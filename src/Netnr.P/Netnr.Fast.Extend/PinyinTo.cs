...
namespace Netnr.Fast
{
    ...
    /// NPinyin
    /// </summary>
    public class PinyinTo
    {
        internal static string[] PyCode = new string[]{
"a     :阿啊吖嗄腌锕",
...
"zuo   :作做左座坐昨佐柞阼唑嘬怍胙祚"};
        ...
        internal static short[][] PyHash = new short[][] {
...
new short[]{57, 84, 129, 138, 165, 243, 244, 259, 280, 282, 290, 380, 383}
        ...
        public static string GetPinyin(char ch)
        {
            ...
            for (var i = 0; i < PyHash[hash].Length; ++i)
            {
                short index = PyHash[hash][i];
                var pos = PyCode[index].IndexOf(ch, 7);
                if (pos != -1)
                    return PyCode[index].Substring(0, 6).Trim();
            }
            return ch.ToString();
        }
        ...
        {
            return (short)((uint)ch % PyCode.Length);
        }
    }
}