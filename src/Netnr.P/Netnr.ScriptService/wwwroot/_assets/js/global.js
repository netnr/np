//低版本跳转
try { eval("() => 1") } catch (e) { top.location = "/oldbrowser/" }
...
let bsnav = {
    ...
    init: function () {
        ...
        document.body.addEventListener('click', function (e) {
            var target = e.target, pnode = target.parentNode || document.body;

            //close
            if (target.classList.contains("btn-close") && pnode.classList.contains("bsnav-header")) {
                e.preventDefault();
            ...
            //open
            if (target.classList.contains("bsnav-menu-toggle") || pnode.classList.contains("bsnav-menu-toggle")) {
