var pdm = {
    ...
    view: function (data) {
        ...
        //搜索
        document.querySelector('.nr-search').addEventListener('input', function () {
            pdm.grid.gridOptions.api.setQuickFilter(this.value.trim());
        }, false);
    ...
    openUrl: function (url) {
        ...
        ss.ajax({
            ...
            success: function (data) {
                ...
                pdm.dataArray = pdm.dataArray.concat(pdm.parse(data));
                pdm.view(pdm.gridData());
