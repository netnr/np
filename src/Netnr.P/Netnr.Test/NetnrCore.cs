...
namespace Netnr.Test
{
    public class NetnrCore
    {
        ...
        public void CaclTo_1_HashBase64()
        {
            ...
            var val1 = Core.CalcTo.HashBase64(Core.CalcTo.HashType.MD5, txt1);
        ...
        public void Extend_1_JSON_Table_List()
        {
            ...
            var jo2 = val1.ToEntity<SharedResultVM>();
            var jo3 = val2.ToEntitys<SharedResultVM>();
            Assert.IsType<SharedResultVM>(jo2);
            Assert.Equal(2, jo3.Count);

            var jo4 = val1.ToType(typeof(SharedResultVM));
            Assert.IsType<SharedResultVM>(jo4);
        ...
        {
            var longid = Core.UniqueTo.LongId();

            Assert.IsType<long>(longid);
            Assert.Equal(19, longid.ToString().Length);
        }
