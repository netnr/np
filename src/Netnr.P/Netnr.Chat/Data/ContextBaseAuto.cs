    ...
    public partial class ContextBase : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NChatMessageToGroup>(entity =>
            {
                ...
                entity.HasIndex(e => e.CmgPullGroupId)
                    .HasName("Index_2");

                entity.HasIndex(e => e.CmgPushUserId)
                    .HasName("Index_1");
            ...
            modelBuilder.Entity<NChatMessageToUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.CmuPullUserId)
                    .HasName("Index_2");

                entity.HasIndex(e => e.CmuPushUserId)
                    .HasName("Index_1");
            ...
            modelBuilder.Entity<NChatUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.CuUserName)
                    .HasName("Index_1");
