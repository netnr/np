...
ndkNoteSQL["SQLite"] = [
  {
    group: 'rely',
    name: "db-env-info",
    sql: `SELECT 'Version' col, sqlite_version() val UNION ALL SELECT 'DateTime' col, datetime() val UNION ALL SELECT 'IgnoreCase' col, 'a' = 'A' val;
PRAGMA encoding`,
    remark: '数据库环境信息'
  },
  {
