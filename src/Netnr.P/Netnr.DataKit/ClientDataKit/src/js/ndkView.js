            ...
            getContextMenuItems: (event) => {
                ...
                var result = [
                    ...
                    },
                    {
                        ...
                        action: function () {
                            //选中或范围项
                            var srows = agg.getSelectedOrRangeRows(ndkVary.gridOpsDatabase);
                            if (srows.length) {
                                var cp = ndkStep.cpGet(1);
    ...
    viewTable: (tables, cobj) => new Promise(resolve => {
        ...
        var opsTable = agg.optionDef({
            ...
            columnDefs: [
                ...
                {
                    field: 'TableRows', headerName: ndkI18n.lg.tableRows, filterParams: agg.filterParamsDef("Number"), aggFunc: 'sum', valueFormatter: (params) => {
                        if (params.value) {
