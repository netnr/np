                ...
                default:
                    {
                        ...
                        Console.WriteLine($"Silent start\r\n--urls {options.Urls} --root {options.Root} --index index.html --charset {options.Charset} --headers access-control-allow-headers:*'access-control-allow-origin:* --auth user:pass\r\n");
