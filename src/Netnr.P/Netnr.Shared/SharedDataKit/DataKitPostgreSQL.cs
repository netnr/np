...
namespace Netnr.SharedDataKit
{
    ...
    /// 实现接口
    /// </summary>
    public class DataKitPostgreSQL : IDataKit
    {
        /// <summary>
        /// 连接
        /// </summary>
        ...
        public DataKitPostgreSQL(DbConnection dbConn)
        {
        ...
        public string GetTableDDL(string tableName, string tableSchema, string databaseName = null)
        {
            ...
            var sql = Configs.GetTableDDLPostgreSQL(tableSchema, tableName);
            db.SqlExecuteReader(sql, includeSchemaTable: true);
