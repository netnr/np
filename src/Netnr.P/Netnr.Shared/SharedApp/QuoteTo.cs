    ...
    public static string Html(string quotes)
    {
        ...
        foreach (var item in listQuote)
        {
            switch (item)
            {
                ...
                case "swiper.css":
                    vh.Add("<link href='https://npm.elemecdn.com/swiper@6.8.2/swiper-bundle.min.css' rel='stylesheet' />");
                    break;

                case "swiper.js":
                    vh.Add("<script src='https://npm.elemecdn.com/swiper@6.8.2/swiper-bundle.min.js'></script>");
                    break;
                ...
                case "tocbot.js":
                    vh.Add("<script src='https://npm.elemecdn.com/tocbot@4.13.0/dist/tocbot.min.js'></script>");
                    break;
                ...
                case "ag-grid-community.js":
                    vh.Add("<script src='https://npm.elemecdn.com/ag-grid-community@25.3.0/dist/ag-grid-community.min.js'></script>");
                    break;

                case "ag-grid-enterprise.js":
                    vh.Add("<script src='https://npm.elemecdn.com/ag-grid-enterprise@25.3.0/dist/ag-grid-enterprise.min.js'></script>");
                    break;
                ...
                case "highcharts.js":
                    vh.Add("<script src='https://npm.elemecdn.com/highcharts@9.1.2/highcharts.js'></script>");
                    break;

                case "hls.js":
                    vh.Add("<script src='https://npm.elemecdn.com/hls.js@1.0.9/dist/hls.min.js'></script>");
                    break;
                ...
                case "nsfwjs":
                    vh.Add("<script src='https://npm.elemecdn.com/@tensorflow/tfjs@3.8.0/dist/tf.min.js'></script>");
                ...
                case "terser.js":
                    vh.Add("<script src='https://npm.elemecdn.com/terser@5.7.1/dist/bundle.min.js'></script>");
                    break;
