    ...
    public static string Html(string quotes)
    {
        ...
        foreach (var item in listQuote)
        {
            switch (item)
            {
                ...
                case "swiper.css":
                    vh.Add("<link href='https://npm.elemecdn.com/swiper@7.0.8/swiper-bundle.min.css' rel='stylesheet' />");
                    break;

                case "swiper.js":
                    vh.Add("<script src='https://npm.elemecdn.com/swiper@7.0.8/swiper-bundle.min.js'></script>");
                    break;
                ...
                case "hls.js":
                    vh.Add("<script src='https://npm.elemecdn.com/hls.js@1.0.11/dist/hls.min.js'></script>");
                    break;
                ...
                case "svgo.js":
                    vh.Add($"<script src='{srServer}/libs/svgo/svgo-v2.7.0.min.js'></script>");
                    break;

                case "device-detector-js.js":
                    vh.Add($"<script src='{srServer}/libs/device-detector-js/device-detector-js-v2.2.10.min.js'></script>");
                    break;
                ...
                case "swagger-ui-dist.css":
                    vh.Add("<link href='https://npm.elemecdn.com/swagger-ui-dist@3.52.4/swagger-ui.css' rel='stylesheet' />");
                    break;
                case "swagger-ui-dist.js":
                    vh.Add("<script src='https://npm.elemecdn.com/swagger-ui-dist@3.52.4/swagger-ui-bundle.js'></script>");
                    vh.Add("<script src='https://npm.elemecdn.com/swagger-ui-dist@3.52.4/swagger-ui-standalone-preset.js'></script>");
                    break;
                ...
                case "monaco-editor":
                    vh.Add("<script src='https://npm.elemecdn.com/monaco-editor@0.29.1/min/vs/loader.js'></script>");
                    vh.Add(@"
                            <script>
                                ...
                                require.config({
                                    paths: {
                                        vs: 'https://npm.elemecdn.com/monaco-editor@0.29.1/min/vs'
                                    },
