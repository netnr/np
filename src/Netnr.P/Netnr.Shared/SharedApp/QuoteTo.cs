        ...
        public static string Html(string quotes)
        {
            ...
            foreach (var item in listQuote)
            {
                switch (item)
                {
                    ...
                    case "fa.css":
                        vh.Add("<link href='https://code.bdstatic.com/npm/font-awesome@4.7.0/css/font-awesome.min.css' rel='stylesheet' />");
                        break;
                    ...
                    case "bootstrap5.css":
                        vh.Add("<link href='https://code.bdstatic.com/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css' rel='stylesheet' />");
                        break;

                    case "bootstrap5.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js'></script>");
                        break;
                    ...
                    case "swiper.css":
                        vh.Add("<link href='https://code.bdstatic.com/npm/swiper@6.7.5/swiper-bundle.min.css' rel='stylesheet' />");
                        break;

                    case "swiper.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/swiper@6.7.5/swiper-bundle.min.js'></script>");
                        break;
                    ...
                    case "tocbot.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/tocbot@4.12.3/dist/tocbot.min.js'></script>");
                        break;
                    ...
                    case "crypto.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/crypto-js@4.0.0/crypto-js.js'></script>");
                        break;
                    ...
                    case "hls.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/hls.js@1.0.7/dist/hls.min.js'></script>");
                        break;
                    ...
                    case "swagger-ui-dist.css":
                        vh.Add("<link href='https://code.bdstatic.com/npm/swagger-ui-dist@3.51.1/swagger-ui.css' rel='stylesheet' />");
                        break;
                    case "swagger-ui-dist.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/swagger-ui-dist@3.51.1/swagger-ui-bundle.js'></script>");
                        vh.Add("<script src='https://code.bdstatic.com/npm/swagger-ui-dist@3.51.1/swagger-ui-standalone-preset.js'></script>");
                        break;
                    ...
                    case "jdenticon.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/jdenticon@3.1.0/dist/jdenticon.min.js'></script>");
                        break;

                    case "jszip.js":
                        vh.Add("<script src='https://code.bdstatic.com/npm/jszip@3.6.0/dist/jszip.min.js'></script>");
                        break;
                    ...
                    case "monaco-editor":
                        vh.Add("<script src='https://code.bdstatic.com/npm/monaco-editor@0.26.1/min/vs/loader.js'></script>");
                        vh.Add(@"
                                <script>
                                    ...
                                    require.config({
                                        paths: {
                                            vs: 'https://code.bdstatic.com/npm/monaco-editor@0.26.1/min/vs'
                                        },
