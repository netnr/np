...
let nrPage = {
    ...
    init: async () => {
        nrVary.domTxtNumber.addEventListener('input', function () {
            let val = nrVary.domTxtNumber.value.trim();
            if (val != "") {
                nrVary.domTxtResult.value = nrPage.rmb(Number(val));
            } else {
    ...
    /**
     * https://github.com/michaellyu/rmb-x
     * @param {*} value 
     * @returns 
     */
    rmb: function (value) {
