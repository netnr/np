...
using Netnr.ResponseFramework.Domain.Entities;
...
public partial class ContextBase : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SbId).HasName("SysButton_SbId_PK");

            entity.ToTable(tb => tb.HasComment("系统按钮表"));
        ...
        modelBuilder.Entity<SysDictionary>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("系统字典表"));

            entity.HasIndex(e => e.SdType, "SysDictionary_SdType").IsClustered();
        ...
        modelBuilder.Entity<SysLog>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("系统日志表"));

            entity.HasIndex(e => e.LogCreateTime, "SysLog_LogCreateTime").IsClustered();
        ...
        {
            entity.HasKey(e => e.SmId).HasName("SysMenu_SmId_PK");

            entity.ToTable(tb => tb.HasComment("系统菜单表"));
        ...
        {
            entity.HasKey(e => e.SrId).HasName("SysRole_SrId_PK");

            entity.ToTable(tb => tb.HasComment("系统角色表"));
        ...
        modelBuilder.Entity<SysTableConfig>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("表配置"));

            entity.HasIndex(e => e.TableName, "SysTableConfig_TableName").IsClustered();
        ...
        {
            entity.HasKey(e => e.SuId).HasName("SysUser_SuId_PK");

            entity.ToTable(tb => tb.HasComment("系统用户表"));
        ...
        {
            entity.ToTable(tb => tb.HasComment("示例表，请删除"));
        ...
        {
            entity.HasKey(e => e.TidId).HasName("TempInvoiceDetail_TidId_PK");

            entity.ToTable(tb => tb.HasComment("单据明细"));
        ...
        {
            entity.HasKey(e => e.TimId).HasName("TempInvoiceMain_TimId_PK");

            entity.ToTable(tb => tb.HasComment("单据主表"));
